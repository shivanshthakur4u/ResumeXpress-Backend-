...
export const AIAnalysis = model("AIAnalysis", { kind: String, inputHash: String, model: String, latency: Number, output: mongoose.Schema.Types.Mixed, resume: mongoose.Schema.Types.ObjectId, job: mongoose.Schema.Types.ObjectId }, [{ userEmail: 1, kind: 1, inputHash: 1 }]);
