...
const CareerProfileSchema = new mongoose.Schema(
  {
    ...
    sections: { type: [new mongoose.Schema({ id: String, type: String, title: String, hidden: Boolean, content: String, entries: { type: [mongoose.Schema.Types.Mixed], default: undefined } }, { _id: false })], default: undefined },
